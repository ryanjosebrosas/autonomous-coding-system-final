...
- **Sub-Plan Path**: `.agents/features/{feature}/plan-phase-1.md`
- **Estimated Tasks**: {3-5}
...
- **Sub-Plan Path**: `.agents/features/{feature}/plan-phase-2.md`
- **Estimated Tasks**: {3-5}
...
- **Sub-Plan Path**: `.agents/features/{feature}/plan-phase-3.md`
- **Estimated Tasks**: {3-5}
...
- [ ] **Phase 1 Review** — Approved by: {name} on {date}
  - Sub-plan: `.agents/features/{feature}/plan-phase-1.md`
  - Status: {pending / approved / changes requested}
  - Notes: {any feedback or concerns}

- [ ] **Phase 2 Review** — Approved by: {name} on {date}
  - Sub-plan: `.agents/features/{feature}/plan-phase-2.md`
  - Status: {pending / approved / changes requested}
  - Notes: {any feedback or concerns}

- [ ] **Phase 3 Review** — Approved by: {name} on {date}
  - Sub-plan: `.agents/features/{feature}/plan-phase-3.md`
  - Status: {pending / approved / changes requested}
  - Notes: {any feedback or concerns}
...
|-------|---------------|--------|-------|-------|
| 1 | `.agents/features/{feature}/plan-phase-1.md` | {pending/in_progress/done} | {N} | {list} |
| 2 | `.agents/features/{feature}/plan-phase-2.md` | {pending/in_progress/done} | {N} | {list} |
| 3 | `.agents/features/{feature}/plan-phase-3.md` | {pending/in_progress/done} | {N} | {list} |
