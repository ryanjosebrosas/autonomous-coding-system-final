...
/execute completes
    ↓
Execution report saved to .agents/reports/{feature}-report.md
    ↓
...
Step 7: Process Improvements (action items)
    ↓
Review saved to .agents/reports/system-reviews/{feature}-review.md
    ↓
...
node scripts/analyze-plan-diff.js .agents/plans/{feature}-plan.md
...
**Data flow:**
```
/code-review → .agents/reviews/{feature}-review.md
    ↓
...
> /system-review .agents/plans/user-auth-plan.md
...
**Output:** `.agents/reports/system-reviews/user-auth-review.md`
...
```bash
> /system-review .agents/plans/payment-flow-plan-overview.md
...
**Output:** `.agents/reports/system-reviews/payment-flow-review.md`
...
# Run first review
> /system-review .agents/plans/{feature}-plan.md
```
