...
**Save location**: `.agents/plans/{feature}-plan.md`
...
**Evidence**: The prime-codebase-redesign plan (`.agents/plans/prime-codebase-redesign-plan.md`) used this format for all 4 tasks and achieved 100% plan-to-implementation fidelity — zero divergences. See `.agents/reports/system-reviews/prime-codebase-redesign-review.md` for the full analysis.
...
```bash
git add .agents/plans/{feature}-plan.md
...
2. **Create structured plan** -> `.agents/plans/{feature}-plan.md`
