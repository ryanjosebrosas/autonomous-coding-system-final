...
.agents/                               # Dynamic content (plans, reviews, reports)
  plans/                               # Layer 2: Feature plans go here
    {feature}-plan.md                  #   Implementation plans from /planning
  reviews/                             # Code review outputs
    {feature}-review.md                #   Code review from /code-review
  reports/                             # Implementation reports
    {feature}-report.md                #   Execution report from /execute
    loops/                             #   /code-loop reports
    system-reviews/                    #   /system-review outputs
  specs/                               # Build specifications
    BUILD_ORDER.md                     #   Feature build sequence
    PILLARS.md                         #   Context pillars
...
| `.agents/` | Dynamic content (plans, reviews, reports) | No (gitignored) |
...
- **Plans**: `.agents/plans/{feature-name}-plan.md` (e.g., `hybrid-retrieval-conversational-orchestrator-plan.md`)
- **Reports**: `.agents/reports/{feature-name}-report.md`
- **Reviews**: `.agents/reviews/{feature-name}-review.md`
- **System Reviews**: `.agents/reports/system-reviews/{feature-name}-review.md`
